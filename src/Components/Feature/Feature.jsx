...
const Feature = () => {
    return (
            <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto pt-20">
                <div class="w-full">
                    ...
                    <div class="pt-11 pb-8 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
                        ...
                        <div class="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
                            ...
                            <p class="font-normal text-lg leading-8 text-gray-400">Jan 01, 2024</p>
                        </div>
                        <p class="font-normal text-lg leading-8 text-gray-400 max-xl:text-justify">Thanks Discount Pro</p>
                    </div>
                    <div class="pt-8 max-xl:max-w-2xl max-xl:mx-auto">
                        ...
                        <h3 class="font-manrope font-semibold text-xl sm:text-2xl leading-9 text-black mb-6">Bought lot of  things
                        </h3>
                        <div class="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
                            <div class="flex items-center gap-3">
                            ...
                            <p class="font-normal text-lg leading-8 text-gray-400">Nov 01, 2024</p>
                        </div>
                        <p class="font-normal text-lg leading-8 text-gray-400 max-xl:text-justify">Offer!! Offer! Offer!</p>
                    </div>
                </div>
            </div>
    );
